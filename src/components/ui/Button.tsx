...
const variantStyles: Record<Variant, string> = {
  ...
  surface: 'bg-transparent text-foreground hover:bg-cyan-primary hover:text-white dark:bg-transparent dark:text-muted dark:hover:bg-cyan-primary dark:hover:text-white',
}
