...
function EpisodesPageInner() {
  const { selectedId, page, listRef, handleSelect, changePage } = useDetailNavigation('episodes')
  ...
  return (
    <MainLayout>
      <DetailHeroSection
        ...
        isLoading={isLoadingEpisode || !episode}
        skeleton={<DetailHeroSkeleton variant="episode" />}
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16" ref={listRef}>
        ...
        <SectionHeaderWithIcon icon={<TvMinimalPlay size={24} className="text-foreground flex-shrink-0" />}>
          Mais<br />episódios
